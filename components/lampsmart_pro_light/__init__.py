...
LampSmartProQueue = lampsmartpro_ns.class_(
    "LampSmartProQueue", cg.Component, cg.Parented.template(esp32_ble.ESP32BLE)
)
...
async def to_code(config):
    # Required for ESPHome >= 2025.8: advertising is conditionally compiled
